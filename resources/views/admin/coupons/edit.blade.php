...
@include('layouts.components.messages')
    <form action="{{route('coupons.update', $coupon->code)}}" method="post">
      ...
      <div class="form-group">
        ...
        <input type="text"
          class="form-control" name="code" id="code" value="{{$coupon->code}}" placeholder="XYZ123">
      </div>
      <div class="form-group">
        <label for="percent-off">Percent Off</label>
        <input type="number"
          class="form-control" name="percent-off" min="0" max="100" value="{{$coupon->percent_off}}" id="percent-off">
      ...
      <div class="form-group">
        ...
        <input type="number"
          class="form-control" name="amount-off" value="{{$coupon->amount_off}}" id="amount-off">
      ...
      <div class="form-group">
        ...
        <input type="number"
          class="form-control" name="times-redeemable-per-person" value="{{$coupon->times_redeemable_per_person}}" max="10" min="1" id="times-redeemable">
      ...
      <div class="form-group">
        ...
        <input type="number"
          class="form-control" name="times-redeemable-total" value="{{$coupon->times_redeemable_total}}" id="times-redeemable-total">
      ...
      <div class="form-group">
        ...
        <input type="number" min="0"
          class="form-control" name="coach-id" value="{{$coupon->coach_id}}" id="coach-id">
      ...
      <div class="form-group">
        ...
        <input type="datetime-local"
          class="form-control" name="redeem-by" value="{{$coupon->redeem_by->format("Y-m-d\TH:i:s")}}" id="redeem-by">
