            ...
            <form class="msform" method="POST" action="{{route('jobs.store')}}">
                ...
                <fieldset class="fieldsetStep" data-name="begin">
                    <div class="modal-header d-block border-0">
                        <h5 class="modal-title h3 futura-bold text-center">Request a session</h5>
                        ...
                        <div class="row">
                            <div class="col-md-11 m-auto">
                                ...
                                <p class="text-center futura-medium mt-2">Take a moment to go through the process of
                                    posting a job that coaches will be able to bid on. Once you are done you'll be able
                                    to pick and choose from a list of coaches you can message.
                ...
                <fieldset class="fieldsetStep" data-name="title">
                    ...
                    <div class="modal-body text-left">
                        <div class="row">
                            <div class="col-md-11 m-auto">
                                <h5 class="h3 futura-bold text-center mt-4">What do you need a coach to help you with?
                                </h5>
                                ...
                                <p class="text-center futura-medium mt-5">Posting a job is free! Treiner takes a 10% cut
                ...
                <fieldset class="fieldsetStep" data-name="description">
                    ...
                    <div class="modal-body text-left">
                        <div class="row">
                            <div class="col-md-11 m-auto">
                                <h5 class="h3 futura-bold text-center mt-4">Please describe the job.</h5>
                                ...
                                <div class="btn-group-toggle mt-3 mb-3">
                                    <div class="btn btn-sm btn-default mb-2 job-addable">I am looking for a coach to work with me by motivating me and making the session enjoyable so I can improve my soccer.</div>
                                    <div class="btn btn-sm btn-default mb-2 job-addable">I want a coach to push me to reach my potential to take me to the next level for when I go back into the team environment.</div>
                                    <div class="btn btn-sm btn-default mb-2 job-addable">I want a really well structured session with multiple activities that are going to work on different areas of my game to improve overall.</div>
                                    <div class="btn btn-sm btn-default mb-2 job-addable">I want to have a fun and enjoyable session that is not going to tire me but allow me to work on the parts of the game I want to.</div>                    
                                </div>
                                    <div class="form-group">
                                    <textarea required maxlength="1500" id="job-textarea" data-length-indicator="details-length-indicator" minlength="50" class="form-control" data-next="details-next" name="details" rows="8"
                                        placeholder="E.g “Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vitae lectus cursus, finibus lectus nec, convallis nisi. Fusce efficitur tempor sem, et volutpat diam cursus ac. Nunc mattis feugiat elit, in laoreet tortor tempus eu. Maecenas nibh nibh, semper vitae pharetra sit amet, dapibus sit amet velit. Curabitur in eleifend leo, in rutrum risus. Vestibulum eget nisi porttitor, pulvinar ex a, maximus leo."></textarea>
                ...
                <fieldset class="fieldsetStep" data-name="budget">
                    ...
                    <div class="modal-body text-left">
                        <div class="row">
                            <div class="col-md-11 m-auto">
                                <h5 class="h3 futura-bold text-center mt-4">Choose how much you want to pay the coach.
                                </h5>
                                <p class="text-center text-muted futura-medium mt-2">This will set the rate you
                                    pay your coach, although coaches can bid higher or lower on your job.</p>
                                <div class="row justify-content-center">
                                    <div class="col-auto"> </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-0">
                        ...
                        <div class="row">
                            <div class="col-md-11 m-auto">
                                ...
                                <p class="text-center futura-medium mt-5">Choose a location from the list that your
                                    training will take place. We will notify coaches in that area once you have posted
                                    this job.</p>
                            </div>
                        </div>
                    </div>
                ...
                <fieldset class="fieldsetStep" data-name="finalise">
                    <div class="modal-header d-block border-0">
                        <h5 class="modal-title h3 futura-bold text-center">Post your job</h5>
                        <button type="button" class="close m-2 p-0" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body text-left">
                        <div class="row">
                            <div class="col-md-11 m-auto text-center">
                                ...
                                <h5 class="h3 futura-bold text-center mt-4">Your job is ready to post!</h5>
                                <p class="text-center futura-medium mt-2">Just click “Submit” below and your job will be
                                    posted for you. You can edit and make changes from the job page.</p>
                            </div>
                        </div>
                    </div>
                    <button class="previous action-button btn btn-primary btn-md" value="Back" name="back">Back</button>
